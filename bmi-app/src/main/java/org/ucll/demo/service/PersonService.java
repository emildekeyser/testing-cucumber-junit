...
import org.ucll.demo.domain.BmiInterpreter;
...
public class PersonService {
	...
	public PersonService() {
		//TODO Use CDI
		setPersonRepository(new PersonStubRepository());
	}
	...
	public String getMessage(String id) {
		Person person = getPersonRepository().get(id);
		return new BmiInterpreter().getMessage(person);
	}
}
